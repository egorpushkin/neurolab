...
AFX_STATIC void AFXAPI __AfxAdjustRectangle(CRect& rect, CPoint pt)
{
...
//		m_rectFrameDragVert.InflateRect(-afxData.cxBorder2, -afxData.cyBorder2);
	...
	__AfxAdjustRectangle(m_rectDragHorz, pt);
	__AfxAdjustRectangle(m_rectDragVert, pt);
	__AfxAdjustRectangle(m_rectFrameDragHorz, pt);
	__AfxAdjustRectangle(m_rectFrameDragVert, pt);
