...
BOOL CSelectLayerDlg::OnInitDialog()
{
	...
	if (iLayersCount == 0)
	{
		pLogProvider->AddLogMessage(CString("TE"), 
			CString("Network does not contain any RBF layers."), 
			CString("RBF Trainer"));
