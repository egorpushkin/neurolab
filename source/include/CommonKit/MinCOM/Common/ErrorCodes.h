#ifndef ERRORCODES_H__MINCOM__COMMONKIT__INCLUDED_
#define ERRORCODES_H__MINCOM__COMMONKIT__INCLUDED_
...
// Custom Common Kit error codes
#define E_ALREADYREGISTRED           ((result)0x80040f01L)
#define E_NOTREGISTRED               ((result)0x80040f02L)
...
#endif // !ERRORCODES_H__MINCOM__COMMONKIT__INCLUDED_
